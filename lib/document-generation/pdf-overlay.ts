...
const FIELD_MAPS: Record<string, FieldMap[]> = {
  '13_declaracao_separacao_fato_inss': [
    ...
    { value: (c) => c.conjuge?.data_separacao ?? '', page: 0, x: 280, y: 610, fontSize: 10 },
    { value: (c) => c.documento.data_extenso, page: 0, x: 110, y: 200, fontSize: 10 },
  ],
  '14_termo_representacao_inss': [
    ...
    { value: (c) => c.documento.data_extenso, page: 0, x: 130, y: 180, fontSize: 10 },
  ],
